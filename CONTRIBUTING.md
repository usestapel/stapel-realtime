# Contributing to stapel-realtime
...
```bash
git clone https://github.com/usestapel/stapel-realtime.git && cd stapel-realtime
...
- **No new hardcoded behavior.** Anything a host project might want to
  ...
  (`STAPEL_REALTIME` dict; see `conf.py`) — with a dotted-path
